...
public class InstallerLogger extends AbstractLogger {
	...
	@Getter private static final Logger infolog = LogManager.getLogger("installer");
	@Getter private static final Logger userlog = LogManager.getLogger("installer.user");
	@Getter private static final Logger debuglog = LogManager.getLogger("installer.debug");
	@Getter private static final Logger errorlog = LogManager.getLogger("error");
